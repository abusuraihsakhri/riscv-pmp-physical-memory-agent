...
import pytest
from riscv_pmp_agent.models import FrontierPayload, ExecutionStatus
from riscv_pmp_agent.engine import FrontierDomainEngine
from riscv_pmp_agent.agents import PMPAddressDecoderAgent, NAPOTRangeValidatorAgent, LockedConfigurationAgent, RISCVPMPCoordinator
from riscv_pmp_agent.cli import main


def test_sub_agents():
    a1 = PMPAddressDecoderAgent()
...
def test_coordinator():
    ...
    assert "RISC-V Privileged Architecture v1.12" in ans or "specifications" in ans
