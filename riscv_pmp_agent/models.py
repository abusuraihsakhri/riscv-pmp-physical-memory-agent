"""
Data Models & Telemetry Definitions for RISC-V Physical Memory Protection (PMP) & ePMP Matrix Agent.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "RISC-V Privileged Architecture v1.12"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
